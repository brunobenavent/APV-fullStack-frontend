...
const Header = () => {
  ...
  return (
    <header className="py-10 bg-indigo-600">
        <div className="container mx-auto flex-col text-center lg:flex-row flex justify-between items-center">
            ...
            <nav className="flex gap-4 flex-col lg:flex-row mt-5 lg:mt-0">
